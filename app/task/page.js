...
export default function page() {
    ...
    return (
        <div className="">
            ...
            <div className="pt-[50vh] grid md:grid-cols-2">
                {tasks.map((task, index) => {
                    return (
                        <div key={index} className="w-full items-center gap-3 max-h-max p-4 bg-white">
                            ...
                            {task.description ?
                                <p className="font-serif p-4 m-4 justify-center text-center">{task.description}</p>
                                :
                                null
                            }
                        </div>
