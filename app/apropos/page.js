            ...
            <section className="z-10 md:w-[80%] flex flex-col items-center">
                ...
                <div className="p-2">
                    ...
                    <ul className="m-4 list-disc">
                        ...
                        <li className="pt-4">
                            Aix-en-Provence, Beaureceuil, Chateauneuf le Rouge, Cadolive, Mimet, Bouc Bel Air, Simiane, Nans les Pins, Saint Zacharrie
                        </li>
                    </ul>
                </div>
                <div className="p-2">
                ...
                <div className="p-2">
                    ...
                    <div className="flex flex-col lg:items-center">
                        <h3 className="font-bold underline pt-4">
                        ...
                        <ul className="grid grid-cols-1 m-4">
                            <li className="py-4">
                                <div className="lg:flex flex-row-reverse gap-10">
                                    <p className="lg:w-1/2 self-center"><span className="font-bold underline pt-4 inline-block">Taille de formation :</span> pour donner une forme harmonieuse aux jeunes arbres</p>
                                    <Image
                                        ref={img0Ref}
                            ...
                            <li className="py-4">
                                <div className="lg:flex gap-10">
                                    <p className="lg:w-1/2 self-center"><span className="font-bold underline pt-4 inline-block">Taille d'entretien :</span> pour supprimer les branches mortes, malades ou mal orientées</p>
                                    <Image
                                        ref={img1Ref}
                            ...
                            <li className="py-4">
                                <div className="lg:flex flex-row-reverse gap-10">
                                    <p className="lg:w-1/2 self-center"><span className="font-bold underline pt-4 inline-block">Taille d'éclaircissage :</span> pour alléger la couronne de l'arbre en supprimant certaines branches</p>
                                    <Image
                                        ref={img2Ref}
                                        src={'/altitude.png'}
                            ...
                            <li className="py-4">
                                <div className="lg:flex gap-10">
                                    <p className="lg:w-1/2 self-center"><span className="font-bold underline pt-4 inline-block">Taille douce :</span> une méthode respectueuse de l'arbre visant à réduire la prise au vent et le poids des branches</p>
                                    <Image
                                        ref={img3Ref}
                                        src={'/tailleDouce.png'}
                                        alt="taille douce"
