    ...
    return (
        <nav className="fixed z-30 bg-white flex justify-around items-center w-screen font-serif font-extrabold uppercase text-lg">
            ...
            <ul className="hidden md:flex gap-10">
                <Link className="w-[150px] text-center p-3 border-[3px] border-transparent hover:border-black" href={'/'}>Travaux</Link>
                <Link className="w-[150px] text-center p-3 border-[3px] border-transparent hover:border-black" href={'/service'}>Service</Link>
                <Link className="w-[150px] text-center p-3 border-[3px] border-transparent hover:border-black" href={'/task'}>Admin</Link>
            ...
            <div className={`md:hidden ${isOpen ? 'block' : 'hidden'} w-full absolute top-[15vh] bg-white animated`}>
                <ul className="flex flex-col left-0 items-center border-x-2 border-b-2">
                    <Link onClick={() => setIsOpen(false)} className="w-[150px] text-center p-3 border-[3px] border-transparent hover:border-black" href={'/'}>travaux</Link>
                    <Link onClick={() => setIsOpen(false)} className="w-[150px] text-center p-3 border-[3px] border-transparent hover:border-black" href={'/service'}>Service</Link>
                    <Link onClick={() => setIsOpen(false)} className="w-[150px] text-center p-3 border-[3px] border-transparent hover:border-black" href={'/task'}>Admin</Link>
